...
class ShoeLocateTestCase(unittest.TestCase):
    ...
    def test_404_get_unknown_bay(self):
        res = self.client().get('/associate/shoe/99999999',
                                headers=store_manager_auth_header)
        data = json.loads(res.data)
    ...
    def test_patch_new_bay(self):
        res = self.client().patch('/manager/bay', json=self.edit_bay,
                                  headers=store_manager_auth_header)
        data = json.loads(res.data)
    ...
    def test_422_if_bay_patch_fails(self):
        res = self.client().patch('/manager/bay', json="",
                                  headers=store_manager_auth_header)
        data = json.loads(res.data)
    ...
    def test_403_patch_bay_unauthorized(self):
        res = self.client().patch('/manager/bay', json=self.edit_bay_403,
                                  headers=assistant_manager_auth_header)
        data = json.loads(res.data)
    ...
    def test_404_patch_unknown_bay(self):
        res = self.client().patch('/manager/bay', json=self.edit_bay_404,
                                  headers=store_manager_auth_header)
        data = json.loads(res.data)
    ...
    def test_delete_bay_authorized(self):
        res = self.client().delete('/manager/bay', json=self.delete_bay,
                                   headers=store_manager_auth_header)
        data = json.loads(res.data)
    ...
    def test_403_delete_bay_unauthorized(self):
        res = self.client().delete(
            '/manager/bay', json={'bay': '1'}, headers=assistant_manager_auth_header)
        data = json.loads(res.data)
    ...
    def test_404_delete_unknown_bay(self):
        res = self.client().delete(
            '/manager/bay', json={'bay': 9999999}, headers=store_manager_auth_header)
        data = json.loads(res.data)
    ...
    def test_422_if_delete_bay_fails(self):
        res = self.client().delete(
            '/manager/bay', json={'bay': 'asfasfafa'}, headers=store_manager_auth_header)
        data = json.loads(res.data)
    ...
    def test_create_new_bay(self):
        res = self.client().post('/manager/bay', json=self.new_bay,
                                 headers=store_manager_auth_header)
        data = json.loads(res.data)
    ...
    def test_422_if_bay_creation_fails(self):
        res = self.client().post('/manager/bay',
                                 json={"difficulty": [1, 2, 3]}, headers=store_manager_auth_header)
        data = json.loads(res.data)
    ...
    def test_exist_Failure(self):
        res = self.client().post('/manager/bay', json=self.existing_bay,
                                 headers=store_manager_auth_header)
        data = json.loads(res.data)
